...
int INIT = 1;
vector<bool> INITS = {false, false, false, false, false, true, false, false, false, false};
...
int main(int argc, char *argv[]) {
    ...
    int sect = stoi(argv[1]);
    int tot = stoi(argv[2]);
    int portion = (hookBsLim / tot);
    for (int hookBs = sect * portion; hookBs < (sect + 1) * portion; hookBs++) {
        vector<int> hookVals;
